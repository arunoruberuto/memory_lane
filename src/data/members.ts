...
export const members: Member[] = [
  ...
  },
  {
    ...
    accent: "#e5e0d6",
    statement:
      "Sound is the floor under the exhibition; even silence has a material weight.",
    tags: ["sound", "field recording", "composition"],
    works: [
      { title: "Dust Loop", medium: "Sound Piece", year: "2026" },
      { title: "Courtyard Drift", medium: "BGM", year: "2025" }
    ]
  },
  {
    id: "yuto-ishida",
...
export function getOtherMembers(id: string): Member[] {
